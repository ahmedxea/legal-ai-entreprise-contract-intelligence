    ...
    <header className="h-16 sticky top-0 z-50 px-6 flex items-center justify-between" style={{
      ...
      <div className="flex items-center gap-1 mx-8 flex-1 justify-center">
        ...
        <div className="relative group hidden lg:block w-48 xl:w-64">
          <Search className="w-3.5 h-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-white/40 transition-colors group-focus-within:text-[#00E0FF]" />
          <input
            type="text"
            ...
            onFocus={(e) => { e.currentTarget.style.border = "1px solid rgba(0,224,255,0.35)"; e.currentTarget.style.boxShadow = "0 0 0 3px rgba(0,224,255,0.1)" }}
      ...
      <div className="flex items-center gap-1.5 flex-shrink-0">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="p-2 rounded-xl hover:bg-white/10 transition-all duration-200 group" title="Notifications">
              <Bell className="w-4 h-4 text-white/70 group-hover:text-[#00E0FF] group-hover:rotate-12 transition-all" />
            </button>
          </DropdownMenuTrigger>
          <DropdownMenuContent align="end" className="rounded-xl w-64 p-4" style={{
            background: "rgba(2,11,27,0.95)",
        ...
        {/* Theme */}
        <button onClick={toggleTheme} className="p-2 rounded-xl hover:bg-white/10 transition-all duration-200 group" title={isDark ? "Light Mode" : "Dark Mode"}>
          {isDark
            ? <Sun className="w-4 h-4 text-white/70 group-hover:text-[#00E0FF] group-hover:rotate-12 transition-all" />
            : <Moon className="w-4 h-4 text-white/70 group-hover:text-[#00E0FF] group-hover:-rotate-12 transition-all" />
          }
        </button>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="flex items-center gap-2 pl-1 pr-2 py-1 rounded-xl hover:bg-white/10 transition-all duration-200 group ml-1">
              <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#007AFF] to-[#00C6FF] flex items-center justify-center text-xs font-bold text-white shadow-[0_0_10px_rgba(0,198,255,0.3)]">
                {initials}
              </div>
          ...
          <DropdownMenuContent align="end" className="rounded-xl w-48 p-2" style={{
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-white/70 hover:text-red-400 hover:bg-red-500/10 transition-all duration-200"
            >
